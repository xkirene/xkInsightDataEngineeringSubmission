...
public class digitalpaymentfinal{
	...
	public static void main(String[] args){
		...
		writeOutput(finalresult,args[5]);
		...
		writeOutput(finalresult2,args[7]);
		ArrayList<Boolean> finalresult4=new ArrayList<Boolean>();
		for(int k=0;k<payer.size();k++){
			boolean singleResult=fraudPaymentCheck(payer.get(k),receiver.get(k),Integer.parseInt(args[8]));
			finalresult4.add(singleResult);
		}
		writeOutput(finalresult4,args[9]);
